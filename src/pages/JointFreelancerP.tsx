...
const JointFreelancerP: FunctionComponent = () => {
  ...
  return (
    <div className="w-full relative bg-white h-[2072px] overflow-hidden flex flex-col items-center justify-start text-center text-9xl text-grey1 font-titre-grey">
      <div className="w-[1512px] relative h-[2015px]">
        ...
        <div className="absolute top-[1378px] left-[275px] rounded-sm bg-silver box-border w-[972px] h-[99px] border-[2px] border-solid border-grey1" />
        ...
        />
        <div className="absolute h-[3.92%] top-[48.73%] bottom-[47.34%] left-[calc(50%_-_297px)] rounded-md bg-white shadow-[0px_4px_12px_-1px_rgba(0,_0,_0,_0.25)] box-border w-[293px] border-[3px] border-solid border-blue" />
        <div
          className="absolute h-[3.92%] top-[48.73%] bottom-[47.34%] left-[calc(50%_+_5px)] rounded-md bg-white shadow-[0px_4px_12px_-1px_rgba(0,_0,_0,_0.25)] box-border w-[293px] cursor-pointer border-[3px] border-solid border-grey1"
          onClick={onRectangle4Click}
        />
        <div className="absolute h-[1.29%] top-[50.07%] left-[calc(50%_-_220px)] tracking-[-0.01em] font-medium font-montserrat text-blue flex items-center justify-center w-[140px]">
          Freelacer
        </div>
        <div
        ...
        <div className="absolute top-[1560px] left-[268px] rounded-[50%] bg-blue w-[86px] h-[86px]" />
        <div className="absolute top-[1560px] left-[707px] rounded-[50%] bg-silver box-border w-[86px] h-[86px] border-[3px] border-solid border-grey1" />
        <div className="absolute top-[1560px] left-[1154px] rounded-[50%] bg-silver box-border w-[86px] h-[86px] border-[3px] border-solid border-grey1" />
        ...
        <div className="absolute top-[1602px] left-[353px] box-border w-[355px] h-0.5 border-t-[2px] border-solid border-grey1" />
        <div className="absolute top-[1601.5px] left-[791.5px] box-border w-[364px] h-[3px] border-t-[3px] border-solid border-grey1" />
        <div className="absolute h-[3.92%] top-[88.39%] bottom-[7.69%] left-[calc(50%_-_233px)] rounded-md bg-white shadow-[0px_4px_12px_-1px_rgba(0,_0,_0,_0.25)] box-border w-[196px] border-[3px] border-solid border-grey1" />
        <div
