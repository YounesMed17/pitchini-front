...
const Login: FunctionComponent = () => {
  ...
  return (
    <div className="w-full relative bg-white h-[1456px] overflow-hidden text-center text-xl text-gray-200 font-paragraphe">
      ...
      <div className="absolute top-[1241px] left-[458px] w-[595px] h-[79px] text-9xl text-grey font-montserrat">
        ...
        />
        <div
          className="absolute h-full top-[0%] bottom-[0%] left-[calc(50%_+_4.5px)] rounded-md bg-white shadow-[0px_4px_12px_-1px_rgba(0,_0,_0,_0.25)] box-border w-[293px] cursor-pointer border-[3px] border-solid border-blue"
        ...
        <div
          className="absolute h-[32.91%] top-[34.18%] left-[calc(50%_+_84.5px)] tracking-[-0.01em] font-medium text-blue flex items-center justify-center w-[133px] cursor-pointer"
