...
const JointFreelancerP2: FunctionComponent = () => {
  ...
  return (
    <div className="w-full relative bg-white h-[1889px] overflow-hidden text-center text-9xl text-grey font-join-text">
      ...
      />
      <div className="absolute h-[4.18%] top-[51.99%] bottom-[43.83%] left-[calc(50%_-_297px)] rounded-md bg-white shadow-[0px_4px_12px_-1px_rgba(0,_0,_0,_0.25)] box-border w-[293px] border-[3px] border-solid border-blue-1" />
      <div className="absolute h-[4.18%] top-[51.99%] bottom-[43.83%] left-[calc(50%_+_5px)] rounded-md bg-white shadow-[0px_4px_12px_-1px_rgba(0,_0,_0,_0.25)] box-border w-[293px] border-[3px] border-solid border-grey" />
      <div className="absolute h-[1.38%] top-[53.41%] left-[calc(50%_-_220px)] tracking-[-0.01em] font-medium font-montserrat text-blue-1 flex items-center justify-center w-[140px]">
        Freelacer
      </div>
      ...
      <div className="absolute top-[1430px] left-[270px] rounded-[50%] bg-grey w-[86px] h-[86px]" />
      <div className="absolute top-[1430px] left-[709px] rounded-[50%] bg-grey box-border w-[86px] h-[86px] border-[3px] border-solid border-grey" />
      <div className="absolute top-[1430px] left-[1156px] rounded-[50%] bg-blue-1 box-border w-[86px] h-[86px] border-[3px] border-solid border-blue-1" />
      ...
      <div className="absolute top-[1472px] left-[355px] box-border w-[355px] h-0.5 border-t-[2px] border-solid border-grey" />
      <div className="absolute top-[1471.5px] left-[793.5px] box-border w-[364px] h-[3px] border-t-[3px] border-solid border-grey" />
      <div
        className="absolute h-[4.18%] top-[87.4%] bottom-[8.42%] left-[calc(50%_-_231px)] rounded-md bg-white shadow-[0px_4px_12px_-1px_rgba(0,_0,_0,_0.25)] box-border w-[196px] cursor-pointer border-[3px] border-solid border-grey"
