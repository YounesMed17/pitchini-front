...
const FrameComponent8: FunctionComponent = () => {
  return (
    <section className="w-[1063.3px] flex flex-col items-start justify-start gap-[51px] max-w-full text-left text-18xl text-white font-paragraphe mq750:gap-[25px_51px]">
      <div className="self-stretch flex flex-col items-start justify-start gap-[23px] max-w-full">
        <div className="self-stretch flex flex-row items-start justify-start py-0 pr-12 pl-11 box-border max-w-full mq1050:pl-[22px] mq1050:pr-6 mq1050:box-border">
          <div className="flex-1 flex flex-row items-end justify-start max-w-full [row-gap:20px] mq1050:flex-wrap">
            ...
            <div className="h-[86px] w-[86px] relative text-grey">
        ...
        <div className="self-stretch flex flex-row items-start justify-between gap-[20px] text-center text-11xl text-grey mq750:flex-wrap">
          ...
          <h3 className="m-0 h-[53px] w-[242px] relative text-inherit font-medium font-inherit text-title inline-block shrink-0 mq1050:text-5xl mq450:text-lg">
            Personal Details
          </h3>
      ...
      <div className="self-stretch flex flex-row items-start justify-center pt-0 pb-[26px] pr-5 pl-[21px] box-border max-w-full">
      ...
      <footer className="self-stretch flex flex-row items-start justify-center py-0 pr-5 pl-[22px] text-left text-base text-gray-3 font-paragraphe">
